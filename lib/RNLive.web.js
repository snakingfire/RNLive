...
export default class RNLive extends Component {
    ...
    componentDidMount = () => {
        ...
        this.Width = vidContainer._reactInternalInstance._renderedComponent._hostNode.clientWidth;
        this.Height = vidContainer._reactInternalInstance._renderedComponent._hostNode.clientHeight;
        ...
        const checkLoad = (e) => {
            console.log('eload', e.ref && e.ref.PercentLoaded && e.ref.PercentLoaded())
            if (e.success) {
                setTimeout(this.startPreview, 1500);
            }
        }
